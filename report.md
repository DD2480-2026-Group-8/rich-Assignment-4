...
| ------------------------------- | ----- | ---- | ------ | ------ | ---- |
| 1. Plenary discussions/meetings | 2     | 2    | 2      |   2    | 2    |
| 2. Discussions within subgroup  | 4     | 2    | 1      |   2    | 1    |
| 3. Reading documentation        | 2.5   | 1.5  | 1.5    |   3    | 2    |
| 4. Configuration and setup      | 0.5   | 0.5  | 0.5    |   1    | 3    |
| 5. Analyzing code/output        | 4     | 3.5  | 6      |   1    | 2    |
| 6. Writing documentation        | 6     | 1.5  | 1      |  1.5   | 2    |
| 7. Writing code                 | 1     | 7    | 6      |   3    | 1    |
| 8. Running code                 | 2     | 2    | 2      |   2    | 1    |
| **Per-person total**            | 22    | 20   | 20     |  15.5  | 14   |
...
Optional (point 7): After picking an issue we got in contact with maintainer, who advised to approach the issue differently from what we have planned initially. We believe it exceeds the scope of the assignment.

## P+ items addressed

We address P+ criteria **1, 3, 4, 6, 7**: (1) architecture overview + diagram, (3) tests traced to requirements, (4) patch clean, (6) SEMAT/software-engineering context, (7) something extraordinary.
